      ...
      >
        ...
        <div className="flex flex-1 items-center justify-end md:justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {session ? (
              <div className="sm:flex sm:gap-2 border-r items-center border-primary pr-4">
                <div class="h-9 w-9">
              ...
              <div className="md:hidden absolute top-24 right-0 bg-white border border-zinc-200 rounded shadow-lg p-6 text-lg ">
                <nav aria-label="Global">
                  <ul className="flex flex-col items-start gap-6 text-md">
                    ...
                    <li>
                      <Link className={`text-accent transition hover:text-accent/75 ${pathname === '/categories' ? active : inActive}`} href="https://bike-rental-api.vercel.app/"
                        onClick={toggleMobileNav}
                      >
                        Admin
                      </Link>
